...
def build_nt_iframe(match_obj):
  ...
  # Don't care about case for iframe type. So, e.g., ESV or esv is fine
  iframe_type = iframe_type.lower()
  ...
  if(iframe_type == "esv"):
    iframe = f'<iframe src="https://www.STEPBible.org/?q=version=ESV|reference={passage}&options=VN" width="100%" height="{height}"></iframe>'
  elif(iframe_type == "nasb"):
    iframe = f'<iframe src="https://www.STEPBible.org/?q=version=NASB_th|reference={passage}&options=VN" width="100%" height="{height}"></iframe>'
  elif(iframe_type == "comparison"):
    iframe = f'<iframe src="https://www.STEPBible.org/?q=version=ESV|version=NASB_th|version=NIV|version=HCSB|reference={passage}&options=VN" width="100%" height="{height}"></iframe>'
  elif(iframe_type == "greek"):
    iframe = f'<iframe src="https://www.STEPBible.org/?q=version=THGNT|reference={passage}&options=VGN" width="100%" height="{height}"></iframe>'
  elif(iframe_type == "greek-i"):
    iframe = f'<iframe src="https://www.STEPBible.org/?q=version=THGNT|version=NASB_th|reference={passage}&options=VGN" width="100%" height="{height}"></iframe>'
  else:
...
def build_ot_iframe(match_obj):
  ...
  if(iframe_type.lower() == "esv"):
    return f'<iframe src="https://www.STEPBible.org/?q=version=ESV|reference={passage}&options=VN" width="100%" height="{height}"></iframe>'
  elif(iframe_type.lower() == "nasb"):
    return f'<iframe src="https://www.STEPBible.org/?q=version=NASB_th|reference={passage}&options=VN" width="100%" height="{height}"></iframe>'
  elif(iframe_type.lower() == "comparison"):
    return f'<iframe src="https://www.STEPBible.org/?q=version=ESV|version=NASB_th|version=NIV|version=HCSB|reference={passage}&options=VN" width="100%" height="{height}"></iframe>'
  elif(iframe_type.lower() == "hebrew"):
